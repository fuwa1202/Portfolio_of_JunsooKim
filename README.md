...
Usage
Place input `.pdb` or `.cif` files in the input directory (default: `/root/For_phyproper`)
Optionally name the reference/wildtype file with a tag: `WT`, `ref`, `test`, or `01`
Run:
```bash
